/**
 * RU06.26.1.53.0 — Store Underwriting and Banking Scores Snapshot Data (#1313)
 *
 ...
 *
 * SPEC (authoritative):
 *   docs/taskTestingUown/RU06.26.1.53.0_storeUnderwritingAndBankingScoresSnapshotData_1313/
 *     RU06.26.1.53.0_storeUnderwritingAndBankingScoresSnapshotData_1313-spec.md
 * Discovery (env/engine routing, source-of-truth):
 *   docs/knowledge-base/1313-npm-segment-tam-score-snapshot-routing.md
 * Reuse: the UW-approval cycle + qa2 caveats (stale sweep tokens, Kornerstone
 *   bank-data, skipMerchantPreflight) come straight from the #1314 spec.
 *
 ...
 *     RU06.26.1.53.0_storeUnderwritingAndBankingScoresSnapshotData_1313.spec.ts --workers=1
 ...
 *
 * GitLab: https://gitlab.com/uown/frontend/origination/-/work_items/1313
 */
...
const TEST_NAME = 'RU06.26.1.53.0_storeUnderwritingAndBankingScoresSnapshotData_1313';
...
// kept only as a portal label, consistent with the #1314 sibling.
...
test.describe(`${TEST_NAME} - qa2/Kornerstone/KS16775`, { tag }, () => {
  ...
  test.skip(
    ...
    async () => {
      ...
      // const accountPk = /* resolveAccountPk(db, ctx.leadPk) — see #1314 spec */;
