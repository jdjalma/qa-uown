...
> Origin: [GitLab svc#554](https://gitlab.com/uown/backend/svc/-/work_items/554) · Milestone: Uown | RU06.26.1.53.0
...
_Source: [GitLab svc#554](https://gitlab.com/uown/backend/svc/-/work_items/554) — BUG/FIX description_
...
_Source: [GitLab svc#554](https://gitlab.com/uown/backend/svc/-/work_items/554) — Additionally section_
...
_Source: AC-04 — [GitLab svc#554](https://gitlab.com/uown/backend/svc/-/work_items/554)_
...
_Source: [GitLab svc#554 comment](https://gitlab.com/uown/backend/svc/-/work_items/554) — Davi Artur: `select * from uown_sv_outbound_api_log where pk = 1696050`_
...
Scenarios asserting that NeuroID is NOT called on a retry are validated via DB assertion: compare the row count in `uown_sv_outbound_api_log` for that `lead_pk` between attempt 1 and attempt 2. If count does not increase, the fix is working. Confirmed by Davi Artur (svc#554 comment: `select * from uown_sv_outbound_api_log where pk = 1696050`).
