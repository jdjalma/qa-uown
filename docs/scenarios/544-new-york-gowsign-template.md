# Test Scenarios — Add New York GowSign Template (svc#544)

> Origin: GitLab uown/backend/svc#544 — "UOWN | SVC | Add New York GowSign Template" (Fernando Martins) · Milestone RU06.26.1.53.0 (release 2026-06-23, envs dev2/qa2)
...
Automated by `tests/e2e/gowsign/ny-gowsign-template-svc544.spec.ts` (`--project=cross-portal`, `ENV=qa2`). Mapping:
