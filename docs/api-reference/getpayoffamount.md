...
Calculates the total amount required to pay off the account
...
```json
{
  ...
  "paths": {
    "/uown/tms/v1/accounts/{accountId}/payoff": {
      "get": {
        "tags": [
          "UOWN TMS SERVICE API"
        ],
        "summary": "Get payoff amount",
        "description": "Calculates the total amount required to pay off the account",
        "operationId": "getPayoffAmount",
        "parameters": [
          {
            "name": "accountId",
            "in": "path",
