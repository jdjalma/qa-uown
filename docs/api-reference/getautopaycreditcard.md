...
# Get autopay credit card

Returns the credit card configured for automatic payments, if any
  ...
  "paths": {
    "/uown/tms/v1/accounts/{accountId}/payment-methods/credit-cards/autopay": {
      "get": {
        ...
        "summary": "Get autopay credit card",
        "description": "Returns the credit card configured for automatic payments, if any",
        "operationId": "getAutopayCreditCard",
        "parameters": [
          {
            "name": "accountId",
            "in": "path",
