...
(async () => {
  try {
    // Lead 11907 — ALL LeadProgramService logs (filter by text, no limit bias)
    console.log('=== qa1 lead 11907 — LeadProgramService / defaulting logs ===');
    ...
    // ANY lead in qa1 with the fix pattern "After defaulting to 13,16 terms are : 13,16"
    console.log('\n=== qa1: leads with "After defaulting to 13,16 terms are : 13,16" ===');
    ...
    // Does qa1 uown_los_lead have 'notes' column?
