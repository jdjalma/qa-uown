...
>
> **Aplicável a:** `subagent-debug-flaky`, `subagent-page-object`, `subagent-impl-e2e`, e análises diretas do Claude. **Não é opcional.**
>
...
### Passo 2 — Definir viewport ≥ 1440px

```
browser_resize({ width: 1440, height: 900 })
```

> **Por quê:** Bootstrap usa `d-lg-block` (breakpoint ≥992px). Em viewports menores, elementos da navbar superior caem em hamburger menu (`display: none`). Investigar em viewport pequeno gera diagnóstico falso ("elemento sumiu"). 1440x900 é o tamanho usado pela suíte real em local headed.
