...
>
> **Como usar (agents):** `subagent-spec-test` DEVE carregar este arquivo antes de fechar o spec. Para cada passo do cenário, consultar o catálogo — se a ação tiver reflexo listado, incluir as validações no spec como passos obrigatórios.
>
...
## Checklist-guia para `subagent-spec-test`
